...
public class AddPost extends BaseForm{
     public AddPost(Resources res,User Us) {
                ...
                else
                {
                    try {
                      ...
                      //  int str2 = Integer.parseInt(blocke.getText());
                        Post e = new Post( title.getText(),description.getText(),str1);
                        if( ServicePost.getInstance().addPo(e))
                            Dialog.show("Success","Nouveau Post Ajouter",new Command("OK"));
