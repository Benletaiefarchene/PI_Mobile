...
public class ModifCom extends BaseForm{
     public ModifCom(Resources res,Post P,User Us,Commentaire C) {
        ...
        TextField cont = new TextField("",C.getContent());
       ...
       // TextField blocke= new TextField("", "blocke");
        Button btnValider = new Button("Modifier Commentaire");
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                      ...
                      Commentaire Po=new Commentaire(C.getId(),C.getPost_id(),C.getUser_id(),cont.getText());
                        if( ServiceCom.getInstance().ModCom(Po))
        ...
        addAll(cont,btnValider,btnAnnuler);
